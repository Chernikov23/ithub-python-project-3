...
def get_dreams_list(
    ...
    dreams, total_count = dreams_service.get_list(
        session=session, limit=limit, offset=offset, author=author
    )
    ...
    return schema.MultipleDreams(dreams=dream_schemas, dreams_count=total_count)
