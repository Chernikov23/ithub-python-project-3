...
Вы находитесь на ветке со **сложным** уровнем. Если вы так и планировали, создайте от нее свою ветку с фамилией и работайте в ней. 
...
| 4.1 Для пункта 3.3 написаны api-тесты на `pytest`, дополнены фикстуры                                                                                   |  | 2    |
| 4.2 Для пункта 3.3 создан документ в коллекции `postman`, написаны тесты                                                                                |  | 1    |
| 4.3 Для пункта 3.4 написаны api-тесты на `pytest` *либо* тесты в `postman` |  | 1 |
| 5. Архитектура                                                                                                                                          | ручная проверка |
| 5.1 Изучите лучшие практики работы с FastAPI, используя блоги, ютюб и популярные репозитории гитхаба. Вам могут встретиться различные архитектурные подходы, например, "чистая архитектура" или "domain-driven design". Выберите источник вдохновения и интегрируйте идеи в этот проект (лучше в отдельной ветке для экспериментов). Если не найдется ничего достойного, можете (а) выделить дополнительный слой "репозиторий", куда вынести непосредственную работу через курсор и сессии, а очищенные сервисы выделите в зависимости, (б) попробовать библиотеки для реализации полноценного dependency injection |  | 3    |

- минус 1 балл за форматирование, присутствие ошибок линтера и статического анализатора
